...
public class DatosProvinciasService {
	...
	private  Stream<Municipio> getStreamMunicipiosProvincia(String provincias) {
		Gson gson = new Gson();
	...
	public List<Municipio> municipiosComunidad(String provincia){
		return getStreamMunicipiosProvincia(provincia)
				.toList();
	}
